...
DURATION_LIMIT_MIN = int(getenv("DURATION_LIMIT", "500000"))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/vicky0604hello/starXmusic",
)
...
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/alfaz_ae_bayan")
